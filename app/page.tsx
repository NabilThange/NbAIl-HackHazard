          ...
          {useCases.map((useCase, index) => (
            ...
            >
              ...
              <Button variant="outline" className="text-white border-blue-500 hover:bg-blue-500/10" asChild> {/* Button border/hover changed to blue */}
                <Link
                  href="/use-cases"
                  // Restore necessary classes for Button asChild to work correctly
                  className="inline-flex items-center justify-center rounded-md px-3 py-2 text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                  prefetch={false}
